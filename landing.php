...
<head>
    ...
    <link rel="stylesheet" href="css2/boxicons.min.css">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 mx-auto text-center">
                    ...
                    <a href="login.php" class="btn me-2 btn-primary">LOGIN</a>
    ...
    <footer>
        ...
        <div class="footer-bottom py-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <p class="mb-0">© 2020 copyright all right reserved</p>
                    </div>
                    <div class="col-md-6">
